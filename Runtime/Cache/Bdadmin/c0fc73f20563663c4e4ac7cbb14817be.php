...
<title><?php echo isset($info['id'])?'编辑':'新增';?>用户</title>
</head>
<body>
		...
		<form class="form form-horizontal skin-minimal input" id="fromcreate"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" name="ad_name"
						value="<?php echo ((isset($info["ad_name"]) && ($info["ad_name"] !== ""))?($info["ad_name"]):''); ?>">
				</div>
			</div>
			...
			<div class="row cl">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
					<input type="hidden" name="ad_id" value="<?php echo ((isset($info["ad_id"]) && ($info["ad_id"] !== ""))?($info["ad_id"]):''); ?>">
