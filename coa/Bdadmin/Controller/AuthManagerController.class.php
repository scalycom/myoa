   ...
   */
    ...
    */
    ...
    public function user($group_id)
    {
        ...
        $model = M()->table($l_table . ' m')->join($r_table . ' a ON m.ad_id=a.uid');
        $_REQUEST = array();
        ...
        ), 'm.ad_id asc', 'm.ad_id,m.ad_name,m.login_time,m.login_ip,m.status');
        int_to_string($list);
        $this->assign('_list', $list);
        $this->assign('auth_group', $auth_group);
        $this->assign('this_group', $auth_group[(int) $_GET['group_id']]);
    ...
    public function group()
    {
        ...
        $nickname = D('Aduser')->getNickName($uid);
        $this->assign('ad_name', $nickname);
